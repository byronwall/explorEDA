...
export const categoricalChartSettings: SavedDataStructure = {
  charts: [
    ...
    {
      title: "How do category counts vary by subcategory and rating?",
      type: "pivot",
      field: "",
    ...
    {
      title: "How does material mix vary by stock status and size?",
      type: "row",
      field: "Material",
